...
kp1 = np.float32([k.pt for k in kp1])
...
"""
result = stitch_image_pair(img1, img2, stitch_direc=1)
#result = stitch_images("../Images/", {"rotated_map.png", "testmap.png"}, 1)
"""
